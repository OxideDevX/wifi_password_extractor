...
echo The work has been completed. Passwords are extracted into a text file ssidswkeysextraxt.txt . All rights reserved. Developed by OxideDevX for Pentesters and Computer Forensics.
pause
